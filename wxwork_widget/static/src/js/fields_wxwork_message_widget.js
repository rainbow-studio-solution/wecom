odoo.define('wxwork_widget.wxwork_message_widget', function (require) {
    "use strict";
    ...
    var _t = core._t;
    /**
     * wxwork_message_widget是一个小部件，用于显示文本区域（正文）和字符数量的文本。 每次用户更改身体时都会计算此文本。
     * 页面中必须有 <field name="msgtype" />  
     */
    var WxworkMessageWidget = FieldTextEmojis.extend({
    ...
    fieldRegistry.add('wxwork_message_widget', WxworkMessageWidget);

    return WxworkMessageWidget;
});