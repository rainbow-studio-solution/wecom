odoo.define('wxwork_widget.ImageURL', function (require) {
    "use strict";
    ...
    var _t = core._t;
    var qweb = core.qweb;
    var WXWorkImageUrl = CharImageUrl.extend({
        _renderReadonly: function () {
            var self = this;
            const url = this.value;
            if (url) {
                var $img = $(qweb.render("WXWorkImageUrl", {
                    widget: this,
                    url: url
                }));
    ...
    fieldRegistry.add('wxwork_image_url', WXWorkImageUrl);
    return {
        WXWorkImageUrl: WXWorkImageUrl
    };
});