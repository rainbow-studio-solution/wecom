odoo.define("web.JsonEditor", function (require) {
    'use strict';
    ...
    var JsonEditor = basic_fields.FieldText.extend({
        ...
        jsLibs: [
            '/web_jsoneditor/static/lib/jsoneditor/js/jsoneditor.js',
        ],
        cssLibs: [
            '/web_jsoneditor/static/lib/jsoneditor/jsoneditor.css',
        ],
        init: function () {
            var self = this;
            ...
            if (this.darktheme) {
                this.cssLibs.push('/web_jsoneditor/static/lib/jsoneditor/css/darktheme.css');
            }
    ...
    field_registry.add('jsoneditor', JsonEditor);
    return JsonEditor;
});