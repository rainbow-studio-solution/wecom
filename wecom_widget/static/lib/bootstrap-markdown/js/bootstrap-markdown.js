...
(function (factory) {
  ...
  $.fn.markdown.defaults = {
    ...
    height: 'inherit',
    resize: 'none',
    iconlibrary: 'fa', //Bootstrap v4.3.1 不包含glyph字体图标
    language: 'en',
    initialstate: 'editor',
    parser: null,
