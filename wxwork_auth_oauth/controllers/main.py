    ...
    def list_providers(self):
        ...
        for provider in providers:
            if (
                ...
                # 一键登录
                return_url = request.httprequest.url_root + "auth_oauth/ww_authorize"
                ...
                # 扫描登录
                return_url = request.httprequest.url_root + "auth_oauth/wwqr"
                state = self.get_state(provider)
                auth_agentid = (
...
class OAuthController(http.Controller):
    ...
    @http.route("/auth_oauth/wwqr", type="http", auth="none")
