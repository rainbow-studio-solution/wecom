...
class WeComApps(models.Model):
    ...
    name = fields.Char(string="Name", required=True, translate=True)  # 企业应用名称
    agentid = fields.Integer(string="Agent ID")  # 企业应用id
    secret = fields.Char("Secret", default="")
    square_logo_url = fields.Char(string="Square Logo")  # 企业应用方形头像
    description = fields.Text(string="Description", translate=True)  # 企业应用详情
